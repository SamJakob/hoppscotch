...
declare module 'vue' {
  export interface GlobalComponents {
    ...
    HistoryRealtimeWebsocketCard: typeof import('./components/history/realtime/websocket/Card.vue')['default']
    ...
    RealtimeSidebar: typeof import('./components/realtime/Sidebar.vue')['default']
